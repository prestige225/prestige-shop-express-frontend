...
def create_produit():
    ...
    # Stocker les deux listes dans la colonne images_urls comme objet {images:[], videos:[]}
    images_urls = json.dumps({'images': images_list, 'videos': videos_list}, ensure_ascii=False)
