...
<style id="chatbot-styles">
    ...
    .chatbot-wave-hand {
        ...
        animation: chatbot-wave 2s ease-in-out;
...
function showSpecialGreetingAnimation() {
    ...
    animationDiv.className = 'chatbot-message flex items-center justify-center my-2';
    animationDiv.innerHTML = `
        <div class="bg-gradient-to-r from-purple-500 to-blue-500 text-white rounded-2xl p-4 shadow-lg animate-pulse">
            <div class="flex items-center space-x-2">
                <span class="chatbot-wave-hand text-2xl">👋</span>
                <span class="font-bold">Je suis PrestIA, votre assistant personnel !</span>
            </div>
        </div>
    `;
