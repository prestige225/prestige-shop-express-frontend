...
def get_produits():
    ...
    try:
        ...
        for produit in produits:
            if produit['images_urls'] and isinstance(produit['images_urls'], str):
                try:
                    import json
            ...
            if produit['taille_disponible'] and isinstance(produit['taille_disponible'], str):
                try:
                    import json
            ...
            if produit['couleur_disponible'] and isinstance(produit['couleur_disponible'], str):
                try:
                    import json
