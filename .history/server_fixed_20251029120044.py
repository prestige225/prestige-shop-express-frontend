...
def update_produit(produit_id):
    ...
    try:
        ...
        # Gérer fusion des images/videos : si l'une ou l'autre est fournie, construire l'objet
        if 'images_urls' in data or 'videos_urls' in data:
            ...
            combined = {'images': new_images, 'videos': new_videos}
            champs.append('images_urls = %s')
            valeurs.append(json.dumps(combined, ensure_ascii=False))
